...
import pomClasess.PortFolioPage;


@Listeners(listenerClass.class)
public class verifyUserCheckPortfolioBalance {
		WebDriver  driver;
		LoginPage lp;
		HomePage hp;
		FundsPage fp;
		...
		public void BeforeClass() {
			htmlReporter = new ExtentHtmlReporter("verifyUserCheckPortfolioBalance.html");
		...
		public  void verifyUserMoveToPortfolioPage() {
			pfp.ClickOnPortfolio();
			Assert.assertTrue(pfp.VisiableOfPortfolio());	
		}
		@Test(priority =3)
		
		public  void verifyUserMoveToEquityPortfolioPage() {
			pfp.ClickOnEquity();
			Assert.assertTrue(pfp.viciableOfEquity());
		 Reporter.log(pfp.valueOfPortfolio().getText());
		}
